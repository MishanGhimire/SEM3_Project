...
CREATE TABLE
  `answer` (`qid` text NOT NULL, `ansid` text NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_general_ci;
...
-- for table `questions`
INSERT INTO
  `questions` (`eid`, `qid`, `qns`, `choice`, `sn`)
VALUES
  (
    '65e1f473b257e',
    '65e1f4e2d7f52',
...
VALUES
  (
    ...
    5,
    5,
    'This is a simple quiz about History.',
    'His',
    '2024-03-01 15:29:55'
  );
