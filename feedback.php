...
<head>
  ...
  <title> A WEB BASED QUIZ GAME FEEDBACK </title>
...
<div class="col-md-10">
<a href="mailto:mishanghimire2003@gmail.com" style="color:#000000">mishanghimire2003@gmail.com</a><br /><br />
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <img src="image/mishan.jfif" width=100 height=100 alt="Mishan Ghimire" class="img-rounded">
            </div>
            <div class="col-md-5">
              <a href="https://github.com/MishanGhimire" style="color:#202020; font-family:'typo' ; font-size:18px"
                title="Find on Github">Mishan Ghimire</a>
              <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+977 9844594654</h4>
              <h4 style="font-family:'typo' ">mishan.ghimire@deerwalk.edu.np</h4>
              <h4 style="font-family:'typo' ">Deerwalk Institute Of Technology</h4>
            </div>
          </div>
          </p>
        </div>
